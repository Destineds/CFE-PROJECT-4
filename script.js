...
//verify age and mask of visitors
if(visitor.age <12){
    deniedVisitors.push(visitor);
    localStorage.setItem("denied", JSON.stringify(deniedVisitors) );
alert("sorry, due to the Covid-19 guildlines,You must be 12 years or older to enter DDS MALL");
}
 ...
 alert("Hello!, welcome to DDS Mall, you may go in");
}
else{
    deniedVisitors.push(visitor);
    localStorage.setItem("denied", JSON.stringify(deniedVisitors) );
    alert("Sorry, you cannot enter DDS Mall at this time.");
